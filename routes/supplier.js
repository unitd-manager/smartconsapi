...
app.post('/getMakePayment', (req, res, next) => {
  ...
  WHERE supHist.purchase_order_id = i.purchase_order_id AND supHist.invoice_paid_status != 'Cancelled' ) as prev_amount 
...
app.post('/getPurchaseOrderLinkedss', (req, res, next) => {
  db.query(`SELECT p.*
    ...
    WHERE supHist.purchase_order_id = p.purchase_order_id AND supHist.invoice_paid_status != 'Cancelled' ) as prev_amount 
...
app.post('/SupplierPayment', (req, res, next) => {
  ...
  ,srh.supplier_receipt_history_id
  ,sr.supplier_id
...
app.post('/editPurchaseStatus', (req, res, next) => {
  db.query(`UPDATE purchase_order 
            SET payment_status = ${db.escape(req.body.payment_status)}
